 ...
 * on 2016-10-04 at 02:32:28 UTC 
 * Modify at your own risk.
 */

package com.example.lukekim.myapplication.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "retrieveRandomJoke".
   *
   * This request holds the parameters needed by the myApi server.  After setting any optional
   * parameters, call the {@link RetrieveRandomJoke#execute()} method to invoke the remote operation.
   *
   * @return the request
   */
  public RetrieveRandomJoke retrieveRandomJoke() throws java.io.IOException {
    RetrieveRandomJoke result = new RetrieveRandomJoke();
    initialize(result);
    return result;
  }

  public class RetrieveRandomJoke extends MyApiRequest<com.example.lukekim.myapplication.backend.myApi.model.MyBean> {

    private static final String REST_PATH = "retrieveRandomJoke";

    /**
     * Create a request for the method "retrieveRandomJoke".
     *
     * This request holds the parameters needed by the the myApi server.  After setting any optional
     * parameters, call the {@link RetrieveRandomJoke#execute()} method to invoke the remote
     * operation. <p> {@link RetrieveRandomJoke#initialize(com.google.api.client.googleapis.services.A
     * bstractGoogleClientRequest)} must be called to initialize this instance immediately after
     * invoking the constructor. </p>
     *
     * @since 1.13
     */
    protected RetrieveRandomJoke() {
      super(MyApi.this, "POST", REST_PATH, null, com.example.lukekim.myapplication.backend.myApi.model.MyBean.class);
    }

    @Override
    public RetrieveRandomJoke setAlt(java.lang.String alt) {
      return (RetrieveRandomJoke) super.setAlt(alt);
    }

    @Override
    public RetrieveRandomJoke setFields(java.lang.String fields) {
      return (RetrieveRandomJoke) super.setFields(fields);
    }

    @Override
    public RetrieveRandomJoke setKey(java.lang.String key) {
      return (RetrieveRandomJoke) super.setKey(key);
    }

    @Override
    public RetrieveRandomJoke setOauthToken(java.lang.String oauthToken) {
      return (RetrieveRandomJoke) super.setOauthToken(oauthToken);
    }

    @Override
    public RetrieveRandomJoke setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (RetrieveRandomJoke) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public RetrieveRandomJoke setQuotaUser(java.lang.String quotaUser) {
      return (RetrieveRandomJoke) super.setQuotaUser(quotaUser);
    }

    @Override
    public RetrieveRandomJoke setUserIp(java.lang.String userIp) {
      return (RetrieveRandomJoke) super.setUserIp(userIp);
    }

    @Override
    public RetrieveRandomJoke set(String parameterName, Object value) {
      return (RetrieveRandomJoke) super.set(parameterName, value);
    }
  }
  ...
  public class SayHi extends MyApiRequest<com.example.lukekim.myapplication.backend.myApi.model.MyBean> {
